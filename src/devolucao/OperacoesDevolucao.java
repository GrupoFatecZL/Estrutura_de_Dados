...
public class OperacoesDevolucao {
	...
	public void MenuDevolucao() {
		...
		while (opcao != 9) {
			...
			"\n2- Listar todas devolucoes"+
			"\n3- Buscar uma devolucao"+
			"\n9- Voltar  "));
	...
	public void CadastrarDevolucao() {  
		...
		try {
			...
			if ( opR.lerArquivos(arqE, Enfeite ) == true ) {
				...
				JOptionPane.showMessageDialog(null, "Tema n�o localizado em Reserva");
				MenuDevolucao();
			}
		...
		System.out.println("Devolucao Registrada: \n" + 
							...
							" - Data Previs�o de devolu��o: " + devolucao.getDataPrevista()+
